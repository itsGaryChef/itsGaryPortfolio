...
`)+`
`+p);const b=T+m+a,A=T+p+o,R=jc(i,i.VERTEX_SHADER,b),E=jc(i,i.FRAGMENT_SHADER,A);i.attachShader(g,R),i.attachShader(g,E),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function P(L){if(s.debug.checkShaderErrors){const k=i.getProgramInfoLog(g)||"",V=i.getShaderInfoLog(R)||"",Y=i.getShaderInfoLog(E)||"",W=k.trim(),j=V.trim(),J=Y.trim();let G=!0,ne=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,R,E);else{const re=Zc(i,R,"vertex"),Se=Zc(i,E,"fragment");ze("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
