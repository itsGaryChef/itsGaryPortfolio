...
export default function Home(){
  ...
  return <main className="game-shell">
    ...
    {!started&&<section className="welcome"><p className="eyebrow">Tonight's experience</p><h1>Welcome to<br/><em>another world.</em></h1><p>Move Chef Void through the restaurant. Every room holds a different part of Gary's work.</p><button className="primary" onClick={()=>setStarted(true)}>Enter the restaurant</button><small>WASD / Arrow keys · Touch controls on mobile</small></section>}
    <div className="controls" aria-label="Movement controls"><span>Move · Drag to orbit · Scroll to zoom</span><div><kbd>W</kbd></div><div><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd></div></div>
